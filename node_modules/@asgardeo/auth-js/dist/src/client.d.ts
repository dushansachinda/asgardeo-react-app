...
import { AuthClientConfig, BasicUserInfo, CryptoUtils, CustomGrantConfig, DecodedIDTokenPayload, FetchResponse, GetAuthURLConfig, OIDCEndpoints, Store, TokenResponse } from "./models";
/**
...
export declare class AsgardeoAuthClient<T> {
     ...
     * @preserve
     */
    constructor(store: Store, cryptoUtils: CryptoUtils);
    /**
     *
