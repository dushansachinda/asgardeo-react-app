        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(this._storage === Storage.WebWorker)) {
                if (!this._client) {
                    ...
                    this._client = yield MainThreadClient(Object.assign(Object.assign({}, defaultConfig), mainThreadClientConfig), (authClient, spaHelper) => {
                ...
                if (!this._client) {
                    ...
                    this._client = (yield WebWorkerClient(Object.assign(Object.assign({}, DefaultConfig), webWorkerClientConfig), this._worker, (authClient, spaHelper) => {
                        return new this._authHelper(authClient, spaHelper);
                    }));
                    return this._client
                        .initialize()
